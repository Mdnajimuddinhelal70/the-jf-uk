...
const events = [
  {
    ...
    description:
      "Join us for a community gathering focused on awareness, collaboration, and creating positive local change.",
  ...
  },
  {
    ...
    description:
      "An interactive workshop designed to connect educators, volunteers, and community members around education.",
  ...
  },
  {
    ...
    month: "SEP",
    category: "Volunteer",
    title: "Volunteer Community Meetup",
    description:
      "Meet our volunteers, learn about upcoming initiatives, and discover how you can contribute to our mission.",
        ...
        <div className="mb-12 flex flex-col gap-6 sm:mb-14 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
              Be There.{" "}
              <span className="text-primary">Be Part of the Change.</span>
            </h2>

            <p className="mt-5 max-w-xl text-base leading-7 text-muted-foreground sm:text-lg">
              Join our upcoming events, meet like-minded people, and become part
              of initiatives that create meaningful change.
            </p>
          </div>
